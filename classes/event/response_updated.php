...
/**
 * Event triggered when a pending AI response is edited.
 *
 * It audits every manual edit of an AI-generated forum reply before its
 * approval, recording who edited the response and whose post originated it.
 *
...
class response_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventresponseupdated', 'local_forum_ai');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' edited the pending AI response with id '$this->objectid' " .
            "originated by the post of the user with id '$this->relateduserid'.";
    }

    /**
     * Returns the URL of the forum the response was edited in.
     *
     * @return \moodle_url
     */
